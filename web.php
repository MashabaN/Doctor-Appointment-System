...
Route::group(['middleware' => 'doctor'], function () {
    ...
    Route::get('/schedule/create',[App\Http\Controllers\ScheduleController::class, 'create'])->name('schedules.create');
...
Route::group(['middleware' => 'patient'], function () {
    ...
    Route::get('/search-doctors', [App\Http\Controllers\UserController::class, 'search'])->name('searchDoctors');
