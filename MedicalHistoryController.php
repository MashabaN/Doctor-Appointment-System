...
class MedicalHistoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Alert::toast('Medical History Successfully added!', 'success');
    ...
    public function edit(MedicalHistory $medicalHistory)
    {
        if ($medicalHistory->patient_id !== auth()->user()->id) {
            Alert::toast('Medical History Not Found!', 'error');
            return redirect('/medicalHistory');
        }
    ...
    public function update(Request $request, MedicalHistory $medicalHistory)
    {
        ...
        Alert::toast('Medical History Successfully Modified!', 'success');
    ...
    public function destroy(MedicalHistory $medicalHistory)
    {
        ...
        Alert::toast('Medical History Successfully Deleted', 'success');
